        ...
        <ScrollArea className="h-96 w-full">
            {appointments.map((item) => (
                ...
                <Link
                    ...
                    className={cn('border mb-2 border-gray-100 shadow-sm text-xs dark:text-slate-900 py-3 px-2 inline-block w-full rounded-md',pathname===`/dashboard/doctors/appointments/view/${item.id}`&& "border-green-700 bg-green-50 border-2")}
                >
